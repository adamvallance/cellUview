...
{\bfseries Gui} (QMain\+Window $\ast$, Ui\+\_\+\+GUI $\ast$, \mbox{\hyperlink{class_gallery}{Gallery}} $\ast$, std\+::vector$<$ \mbox{\hyperlink{classimage_processor}{image\+Processor}} $\ast$ $>$ \&)
\item 
