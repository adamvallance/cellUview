...
It is recommended to use a Raspberry Pi 4B for OpenFlexure. In order to use cellUview, we advise using a clean install of Raspbian v10 (Buster). 
...
It is reccomended to use a Raspberry Pi 4B 
Pi should run Raspbian v10 Buster
Don't use OpenFlexure software.
